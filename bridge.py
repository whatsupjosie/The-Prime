...
class VoxelBridge:
    def __init__(self, data_dir: Path) -> None:
        ...
        # Compatibility queue attribute used by e-PETE metrics.  The simple
        # bridge sends synchronously, so this remains empty unless a richer
        # bridge replaces it.
        self._command_queue = []
    ...
    def send_recording_control(self, action: str, parameters: Dict[str, Any]) -> bool:
        return self.send_command("RECORDING_CONTROL", {"action": action, **parameters})
